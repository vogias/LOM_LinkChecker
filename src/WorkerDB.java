 ...
 * 
 */
public class WorkerDB implements Runnable {
	...
	public WorkerDB(String provider, File inputFile,
			lom_linkchecker ods_linkchecker, Connection conn, String tbName,
			File brokenFolder, Logger slf4jLogger) {
